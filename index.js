...
const loadData = async (seemoreclicked) => {
...
const loadDetail = async (ai) => {
  ...
  <br/>
  <div class="px-7 py-6 flex justify-center items-center gap-2">
  <div class="bg-white rounded-2xl text-[#03a30a] text-center font-bold p-6">${
    details.pricing[0].price
  }</div>
  <div class="bg-white rounded-2xl text-[#f28927] text-center font-bold p-6">${
    details.pricing[1].price
  }</div>
  <div class="bg-white rounded-2xl text-[#eb5757] text-center font-bold p-6">${
  ...
  <div class="flex justify-center items-center gap-3 pb-6 ">
    ...
    <ul>
    <li class="text-[#585858] font-normal">${
      details.features[1].feature_name
    }</li>
    <li class="text-[#585858] font-normal">${
      details.features[2].feature_name
    }</li>
    <li class="text-[#585858] font-normal">${
      details.features[3].feature_name
    }</li>
    </ul>
    </div>
  ...
  <div class = "relative">
  <p class="absolute top-6 right-6 text-[10px] py-2 px-5 bg-[#eb5757] rounded-lg text-white text-center font-semibold">${details.accuracy.score*100}% accuracy</p>
  <img class="p-3 rounded-2xl" src="${details.image_link[0]}"/>
  </div>
  <h3 class="text-black text-center text-2xl font-semibold">${
    details.input_output_examples[0].input
  }</h3>
  <h3 class="pt-3 pb-6 px-6 text-[#585858] text-center font-normal">${
...
// activating sort by date button
