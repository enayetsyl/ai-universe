...
const loadDetail = async (ai) => {
  ...
  modalDiv.innerHTML = `
    ...
    <br/>
    <div class="px-7 py-6">
    <span class="bg-white rounded-2xl text-[#03a30a] text-center font-bold p-6">${
      details.pricing[0].price
    }</span>
    <span class="bg-white rounded-2xl text-[#f28927] text-center font-bold p-6">${
      details.pricing[1].price
    }</span>
    <span class="bg-white rounded-2xl text-[#eb5757] text-center font-bold p-6">${
